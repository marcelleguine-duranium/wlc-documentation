...
export const ROTAS = [
  ...
  { slug: 'admin-adicionar-repositorio', path: '/admin/repositories', titulo: 'Administração — Adicionar repositório', secao: 'admin', auth: 'privada',
    passos: [{ clicar: 'Adicionar repositório' }, { esperar: 2000 }],
    nota: 'Diálogo de seleção de repositórios, aberto sobre a lista. Mostra a cota do plano; a sequência para antes do botão que adiciona. Capturar com WLC_ESCALA=4: o diálogo tem 510 px de largura em 1x e, em 2x, o recorte renderiza a 149 dpi na coluna do PDF.' },
...
export const ROTAS_EXCLUIDAS = [
  ...
  { path: '/contexts/:contextId/insights', motivo: 'link antigo; redireciona para a aba Insights da home do contexto, capturada como contexto-insights' },
  { path: '/contexts/:contextId/repo/:repoId/ai-insights', motivo: 'link antigo; redireciona para a aba Insights IA da home do repositório, capturada como repo-insights' },
  { path: '/dependencies', motivo: 'mesma tela de Dependências no escopo do workspace; capturada no escopo de contexto' },
  { path: '/contexts/:contextId/repo/:repoId/dependencies', motivo: 'mesma tela de Dependências no escopo do repositório; capturada no escopo de contexto' },
