...
## Módulo 3 — Perguntas frequentes

Respostas curtas para as dúvidas mais comuns, cada uma apontando para a seção que
trata do assunto em detalhe.

| Seção | Conteúdo |
| --- | --- |
| [Acesso e navegação](m3-01-faq-acesso.md) | Login, senha, workspace único, visibilidade de repositórios e convites |
